      ...
      <div class="pay-box">
        ...
        <div class="pay-qrcode">
          ...
          <div class="qrcode-placeholder">
            ...
            <div class="qr-text">请添加收款码图片</div>
            <div class="qr-hint">将收款码放到 public/qrcode.png</div>
          </div>
          <div class="pay-tip">微信扫码支付 ¥{{ selectedItem?.price }}</div>
        </div>
...
.qr-text { font-size: 12px; color: var(--text); }
.qr-hint { font-size: 10px; color: var(--text-dim); }
